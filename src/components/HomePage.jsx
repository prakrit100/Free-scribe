...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            ...
            <h2 className='font-medium text-3xl sm:text-4xl md:text-5xl m-4'>Convert audio <span className='text-blue-400'>into</span> <span className='text-blue-400'>text, then translate it.</span></h2>
            ...
            <h2>Built by <span className='text-blue-400 text-2xl'>Prakrit</span></h2>
        </main>
    )
}